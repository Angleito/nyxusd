...
export declare const OptionUtils: {
     ...
     * @returns Function that works with Option values
     */
    lift2<A, B, C>(fn: (a: A, b: B) => C): (optionA: Option<A>, optionB: Option<B>) => Option<C>;
    /**
     * Lifts a ternary function to work with Option values
     * @param fn - Ternary function to lift
     * @returns Function that works with Option values
     */
    lift3<A, B, C, D>(fn: (a: A, b: B, c: C) => D): (optionA: Option<A>, optionB: Option<B>, optionC: Option<C>) => Option<D>;
    /**
