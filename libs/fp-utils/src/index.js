...
export { curry, curry2, curry3, curry4, curry5, uncurry, partial, partialRight, flip, arity, unary, binary, spread, unspread, reverseArgs, CurryUtils } from './curry';
...
export const Validation = {
     ...
     */
    validate: (predicate, value) => predicate(value) ? Option.some(value) : Option.none(),
    /**
