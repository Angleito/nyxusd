...
export const Validation = {
   ...
   */
  positive: (num: number) => (num > 0 ? Option.some(num) : Option.none()),
   ...
   */
  nonNegative: (num: number) => (num >= 0 ? Option.some(num) : Option.none()),
