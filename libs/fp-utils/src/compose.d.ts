...
export declare function pipe<A, B, C, D, E, F, G, H, I, J, K>(value: A, fn1: (a: A) => B, fn2: (b: B) => C, fn3: (c: C) => D, fn4: (d: D) => E, fn5: (e: E) => F, fn6: (f: F) => G, fn7: (g: G) => H, fn8: (h: H) => I, fn9: (i: I) => J, fn10: (j: J) => K): K;
/**
...
export declare function compose<A, B>(fn1: (b: B) => A, fn2: (a: A) => B): (a: A) => A;
export declare function compose<A, B, C>(fn1: (c: C) => A, fn2: (b: B) => C, fn3: (a: A) => B): (a: A) => A;
export declare function compose<A, B, C, D>(fn1: (d: D) => A, fn2: (c: C) => D, fn3: (b: B) => C, fn4: (a: A) => B): (a: A) => A;
export declare function compose<A, B, C, D, E>(fn1: (e: E) => A, fn2: (d: D) => E, fn3: (c: C) => D, fn4: (b: B) => C, fn5: (a: A) => B): (a: A) => A;
export declare function compose<A, B, C, D, E, F>(fn1: (f: F) => A, fn2: (e: E) => F, fn3: (d: D) => E, fn4: (c: C) => D, fn5: (b: B) => C, fn6: (a: A) => B): (a: A) => A;
export declare function compose<A, B, C, D, E, F, G>(fn1: (g: G) => A, fn2: (f: F) => G, fn3: (e: E) => F, fn4: (d: D) => E, fn5: (c: C) => D, fn6: (b: B) => C, fn7: (a: A) => B): (a: A) => A;
export declare function compose<A, B, C, D, E, F, G, H>(fn1: (h: H) => A, fn2: (g: G) => H, fn3: (f: F) => G, fn4: (e: E) => F, fn5: (d: D) => E, fn6: (c: C) => D, fn7: (b: B) => C, fn8: (a: A) => B): (a: A) => A;
export declare function compose<A, B, C, D, E, F, G, H, I>(fn1: (i: I) => A, fn2: (h: H) => I, fn3: (g: G) => H, fn4: (f: F) => G, fn5: (e: E) => F, fn6: (d: D) => E, fn7: (c: C) => D, fn8: (b: B) => C, fn9: (a: A) => B): (a: A) => A;
export declare function compose<A, B, C, D, E, F, G, H, I, J>(fn1: (j: J) => A, fn2: (i: I) => J, fn3: (h: H) => I, fn4: (g: G) => H, fn5: (f: F) => G, fn6: (e: E) => F, fn7: (d: D) => E, fn8: (c: C) => D, fn9: (b: B) => C, fn10: (a: A) => B): (a: A) => A;
/**
...
export declare function flow<A, B, C, D, E, F, G>(fn1: (a: A) => B, fn2: (b: B) => C, fn3: (c: C) => D, fn4: (d: D) => E, fn5: (e: E) => F, fn6: (f: F) => G): (a: A) => G;
export declare function flow<A, B, C, D, E, F, G, H>(fn1: (a: A) => B, fn2: (b: B) => C, fn3: (c: C) => D, fn4: (d: D) => E, fn5: (e: E) => F, fn6: (f: F) => G, fn7: (g: G) => H): (a: A) => H;
export declare function flow<A, B, C, D, E, F, G, H, I>(fn1: (a: A) => B, fn2: (b: B) => C, fn3: (c: C) => D, fn4: (d: D) => E, fn5: (e: E) => F, fn6: (f: F) => G, fn7: (g: G) => H, fn8: (h: H) => I): (a: A) => I;
export declare function flow<A, B, C, D, E, F, G, H, I, J>(fn1: (a: A) => B, fn2: (b: B) => C, fn3: (c: C) => D, fn4: (d: D) => E, fn5: (e: E) => F, fn6: (f: F) => G, fn7: (g: G) => H, fn8: (h: H) => I, fn9: (i: I) => J): (a: A) => J;
export declare function flow<A, B, C, D, E, F, G, H, I, J, K>(fn1: (a: A) => B, fn2: (b: B) => C, fn3: (c: C) => D, fn4: (d: D) => E, fn5: (e: E) => F, fn6: (f: F) => G, fn7: (g: G) => H, fn8: (h: H) => I, fn9: (i: I) => J, fn10: (j: J) => K): (a: A) => K;
/**
...
export declare const ComposeUtils: {
     ...
     */
    branch: <T, U>(predicate: (value: T) => boolean, onTrue: (value: T) => U, onFalse: (value: T) => U) => (value: T) => U;
    /**
     ...
     */
    cond: <T, U>(cases: Array<[(value: T) => boolean, (value: T) => U]>, defaultFn: (value: T) => U) => (value: T) => U;
    /**
     ...
     */
    when: <T>(predicate: (value: T) => boolean, transform: (value: T) => T) => (value: T) => T;
    /**
     ...
     * @returns Function that conditionally transforms
     */
    unless: <T>(predicate: (value: T) => boolean, transform: (value: T) => T) => (value: T) => T;
    /**
     ...
     */
    throttle: <T extends any[], U>(fn: (...args: T) => U, interval: number) => (...args: T) => U | undefined;
    /**
     ...
     */
    retry: <T extends any[], U>(fn: (...args: T) => U, maxAttempts: number, delay?: number) => (...args: T) => U;
};
