 ...
 * @returns Curried function
 */
export declare function curry3<A, B, C, R>(
  fn: (a: A, b: B, c: C) => R,
): Curry3<A, B, C, R>;
/**
 ...
 * @returns Curried function
 */
export declare function curry4<A, B, C, D, R>(
 ...
 * @returns Curried function
 */
export declare function curry5<A, B, C, D, E, R>(
 ...
 */
export declare function uncurry<T extends any[], R>(
  fn: (...args: any[]) => any,
  arity: number,
): (...args: T) => R;
/**
 ...
 */
export declare function partial<T extends any[], U extends any[], R>(
  fn: (...args: [...T, ...U]) => R,
  ...args: T
): (...rest: U) => R;
/**
 ...
 * @returns Partially applied function
 */
export declare function partialRight<T extends any[], U extends any[], R>(
  fn: (...args: [...T, ...U]) => R,
  ...args: U
): (...rest: T) => R;
/**
 ...
 */
export declare function flip<A, B, Rest extends any[], R>(
 ...
 */
export declare function arity<T extends any[], R>(
  n: number,
  fn: (...args: T) => R,
): (...args: any[]) => R;
/**
 ...
 */
export declare function unary<T, R>(
  fn: (arg: T, ...rest: any[]) => R,
): (arg: T) => R;
/**
 ...
 */
export declare function binary<A, B, R>(
 ...
 */
export declare function spread<T extends any[], R>(
  fn: (...args: T) => R,
): (args: T) => R;
/**
 ...
 */
export declare function unspread<T extends any[], R>(
  fn: (args: T) => R,
): (...args: T) => R;
/**
 ...
 */
export declare function reverseArgs<T extends any[], R>(
  fn: (...args: T) => R,
): (...args: T) => R;
/**
