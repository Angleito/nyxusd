...
export declare const FP: {
    ...
    readonly find: <T>(a: (item: T) => boolean) => (b: T[]) => T;
    ...
    readonly match: import("./curry").Curry2<RegExp, string, RegExpMatchArray>;
...
export declare namespace FPTypes {
    ...
    type CurriedFunction<T extends any[], R> = T extends [
        infer A,
        ...infer Rest
    ] ? Rest extends any[] ? (arg: A) => CurriedFunction<Rest, R> : (arg: A) => R : R;
    /**
