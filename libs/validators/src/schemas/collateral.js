import { z } from "zod";
import { AddressSchema, BigIntSchema, AmountSchema, OptionalAmountSchema, PriceSchema, BasisPointsSchema, PercentageSchema, TimestampSchema, HashSchema, AssetTypeSchema, RiskLevelSchema, MetadataSchema, NetworkSchema, ChainIdSchema, } from "./common.js";
/**
...
export const BatchCollateralOperationSchema = z.object({
    ...
    operations: z.array(z.union([CollateralDepositSchema, CollateralWithdrawalSchema])),
    // Batch validation
