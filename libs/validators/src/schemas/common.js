...
export const AmountSchema = BigIntSchema.refine((val) => val > 0n, "Amount must be positive");
export const OptionalAmountSchema = BigIntSchema.refine((val) => val >= 0n, "Amount must be non-negative");
...
export const DateRangeSchema = z
    ...
    .refine((data) => data.startDate <= data.endDate, "Start date must be before or equal to end date");
