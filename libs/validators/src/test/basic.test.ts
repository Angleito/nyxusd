...
describe('@nyxusd/validators - Basic Tests', () => {
  describe('Address Validation', () => {
    ...
    it('should sanitize addresses correctly', () => {
      const testCases = [
        { input: '  0X742D35CC6634C0532925A3B8D  ', expected: '0x742d35cc6634c0532925a3b8d' },
        { input: '0xA0B86A33E6441B8BD39F9B6C2F3C0D7', expected: '0xa0b86a33e6441b8bd39f9b6c2f3c0d7' },
...
describe('Integration Tests', () => {
  it('should handle complex validation scenarios', () => {
    ...
    const assetResult = validate(AddressSchema, cdpCreationData.initialCollateral.assetAddress);
    const amountResult = validate(AmountSchema, cdpCreationData.initialCollateral.amount);
