 ...
 */
export type CollateralTypeId = string & { readonly __brand: 'CollateralTypeId' }
 ...
 */
export const mkCollateralTypeId = (id: string): CollateralTypeId => id as CollateralTypeId
 ...
 */
export const mkVolatilityScore = (score: number): VolatilityScore => score as VolatilityScore
...
export type CollateralOperation = 
  ...
  | { readonly type: 'liquidate'; readonly amount: Amount; readonly liquidationPrice: Price }
...
export type CollateralError = 
  | { readonly type: 'insufficient_balance'; readonly available: Amount; readonly requested: Amount }
  | { readonly type: 'insufficient_available'; readonly available: Amount; readonly requested: Amount }
  | { readonly type: 'collateral_type_not_found'; readonly id: CollateralTypeId }
  | { readonly type: 'collateral_type_deprecated'; readonly id: CollateralTypeId }
  | { readonly type: 'price_feed_stale'; readonly collateralType: CollateralTypeId; readonly lastUpdate: Timestamp }
  | { readonly type: 'price_feed_unavailable'; readonly collateralType: CollateralTypeId }
  | { readonly type: 'oracle_deviation_too_high'; readonly deviation: number; readonly maxDeviation: number }
  | { readonly type: 'emergency_shutdown'; readonly collateralType: CollateralTypeId }
