 ...
 */
export type CDPId = string & {
    readonly __brand: "CDPId";
};
/**
 ...
 */
export declare const mkCDPId: (id: string) => CDPId;
/**
 ...
 */
export declare const mkAmount: (value: bigint) => Amount;
/**
 * Collateralization ratio as a percentage (basis points)
 * 10000 = 100%, 15000 = 150%
 */
export type CollateralizationRatio = number & {
    readonly __brand: "CollateralizationRatio";
};
/**
 ...
 */
export declare const mkCollateralizationRatio: (ratio: number) => CollateralizationRatio;
/**
 ...
 */
export declare const mkTimestamp: (ms: number) => Timestamp;
/**
...
export type CDPError = {
    ...
    readonly type: "below_min_collateral_ratio";
    readonly current: CollateralizationRatio;
    readonly minimum: CollateralizationRatio;
} | {
    readonly type: "debt_ceiling_exceeded";
    readonly ceiling: Amount;
    readonly requested: Amount;
} | {
    readonly type: "below_min_debt";
    readonly minimum: Amount;
    readonly provided: Amount;
} | {
    readonly type: "cdp_not_found";
    readonly id: CDPId;
} | {
    readonly type: "cdp_already_liquidated";
    readonly id: CDPId;
} | {
    readonly type: "cdp_already_closed";
    readonly id: CDPId;
} | {
    ...
    readonly state: CDPState["type"] | string;
} | {
    readonly type: "invalid_amount";
    readonly amount: Amount;
} | {
    readonly type: "deposit_limit_exceeded";
    readonly limit: Amount;
    readonly requested: Amount;
} | {
    readonly type: "withdrawal_limit_exceeded";
    readonly limit: Amount;
    readonly requested: Amount;
} | {
    readonly type: "insufficient_available_collateral";
    readonly available: Amount;
    readonly requested: Amount;
} | {
    readonly type: "mint_limit_exceeded";
    readonly limit: Amount;
    readonly requested: Amount;
} | {
    readonly type: "burn_amount_exceeds_debt";
