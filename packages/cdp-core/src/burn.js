...
exports.calculateBurnAllocation = calculateBurnAllocation;
/**
 ...
 * ```
 */
const validateBurnNYXUSD = (params, context) => {
    ...
    const accruedFees = (0, exports.calculateAccruedFees)(params.cdp.debtAmount, context.stabilityFeeRate, context.timeElapsed);
...
exports.validateBurnNYXUSD = validateBurnNYXUSD;
/**
 ...
 * ```
 */
const calculateHealthFactorAfterBurn = (collateralAmount, currentDebt, principalRepaid, collateralPrice, liquidationRatio) => {
...
exports.calculateHealthFactorAfterBurn = calculateHealthFactorAfterBurn;
/**
 ...
 * ```
 */
const updateCDPStateAfterBurn = (currentState, remainingDebt, newHealthFactor, autoClose, timestamp) => {
...
exports.updateCDPStateAfterBurn = updateCDPStateAfterBurn;
/**
 ...
 * ```
 */
const burnNYXUSD = (params, context) => {
    // Validate burning parameters and system state
    const validationResult = (0, exports.validateBurnNYXUSD)(params, context);
    ...
    const allocation = (0, exports.calculateBurnAllocation)(params.burnAmount, params.cdp.debtAmount, accruedFees);
    ...
    const newHealthFactor = (0, exports.calculateHealthFactorAfterBurn)(params.cdp.collateralAmount, params.cdp.debtAmount, allocation.principalPayment, context.collateralPrice, params.cdp.config.liquidationRatio);
    // Update CDP state based on remaining debt and system settings
    const newState = (0, exports.updateCDPStateAfterBurn)(params.cdp.state, allocation.remainingDebt, newHealthFactor, context.autoCloseCDP, params.timestamp);
    // Create updated CDP with reduced debt
    const updatedCDP = (0, exports.createUpdatedCDP)(params.cdp, allocation.principalPayment, allocation.feesPayment, newState, params.timestamp);
    ...
    return fp_utils_1.Result.ok(burnResult);
};
exports.burnNYXUSD = burnNYXUSD;
/**
 ...
 * ```
 */
const burnNYXUSDBatch = (burns, context) => {
    const results = [];
    for (const params of burns) {
        const result = (0, exports.burnNYXUSD)(params, context);
        if (result.isErr()) {
...
exports.burnNYXUSDBatch = burnNYXUSDBatch;
/**
 ...
 * ```
 */
const estimateMinBurnForHealthFactor = (cdp, targetHealthFactor, collateralPrice, stabilityFeeRate, timeElapsed) => {
    // Calculate total debt including accrued fees
 ...
 * ```
 */
const calculateHealthFactorImprovement = (cdp, burnAmount, collateralPrice, stabilityFeeRate, timeElapsed) => {
    const current = (0, exports.calculateCurrentHealthFactor)(cdp, collateralPrice);
    // Calculate burn allocation
    const accruedFees = (0, exports.calculateAccruedFees)(cdp.debtAmount, stabilityFeeRate, timeElapsed);
    const allocation = (0, exports.calculateBurnAllocation)(burnAmount, cdp.debtAmount, accruedFees);
    const afterBurn = (0, exports.calculateHealthFactorAfterBurn)(cdp.collateralAmount, cdp.debtAmount, allocation.principalPayment, collateralPrice, cdp.config.liquidationRatio);
