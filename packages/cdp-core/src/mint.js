 ...
 * ```
 */
const validateMintNYXUSD = (params, context) => {
...
exports.validateMintNYXUSD = validateMintNYXUSD;
/**
 ...
 * ```
 */
const calculateMaxMintableAmount = (cdp, collateralPrice, stabilityFeeRate, timeElapsed) => {
    // Calculate accrued fees
    ...
    const maxTotalDebt = (collateralValue * BigInt(10000)) /
 ...
 * ```
 */
const calculateHealthFactorAfterMint = (collateralAmount, currentDebt, mintAmount, accruedFees, collateralPrice, liquidationRatio) => {
...
exports.calculateHealthFactorAfterMint = calculateHealthFactorAfterMint;
/**
 ...
 * ```
 */
const updateCDPStateAfterMint = (_currentState, newHealthFactor, _liquidationRatio) => {
...
exports.updateCDPStateAfterMint = updateCDPStateAfterMint;
/**
 ...
 * ```
 */
const mintNYXUSD = (params, context) => {
    // Validate minting parameters and system state
    const validationResult = (0, exports.validateMintNYXUSD)(params, context);
    ...
    const newHealthFactor = (0, exports.calculateHealthFactorAfterMint)(params.cdp.collateralAmount, params.cdp.debtAmount, params.mintAmount, accruedFees, context.collateralPrice, params.cdp.config.liquidationRatio);
    // Update CDP state based on new health factor
    const newState = (0, exports.updateCDPStateAfterMint)(params.cdp.state, newHealthFactor, params.cdp.config.liquidationRatio);
    // Create updated CDP with increased debt
    const updatedCDP = (0, exports.createUpdatedCDP)(params.cdp, params.mintAmount, accruedFees, newState, params.timestamp);
 ...
 * ```
 */
const mintNYXUSDBatch = (mints, context) => {
    const results = [];
    ...
    for (const params of mints) {
        ...
        const result = (0, exports.mintNYXUSD)(params, updatedContext);
        if (result.isErr()) {
...
exports.mintNYXUSDBatch = mintNYXUSDBatch;
/**
 ...
 * ```
 */
const calculateCollateralizationRatioAfterMint = (cdp, mintAmount, collateralPrice, stabilityFeeRate, timeElapsed) => {
    const accruedFees = (0, exports.calculateAccruedFees)(cdp.debtAmount, stabilityFeeRate, timeElapsed);
...
exports.calculateCollateralizationRatioAfterMint = calculateCollateralizationRatioAfterMint;
