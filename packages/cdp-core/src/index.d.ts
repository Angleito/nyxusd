...
export type { DepositCollateralParams, DepositContext, DepositResult, } from "./deposit";
...
export type { WithdrawCollateralParams, WithdrawContext, WithdrawResult, } from "./withdraw";
...
export type { BurnNYXUSDParams, BurnContext, BurnResult, BurnAllocation, } from "./burn";
export declare const CDP_MODULE_VERSION = "1.0.0";
