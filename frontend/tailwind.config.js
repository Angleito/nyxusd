  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-midnight': 'linear-gradient(135deg, #0a0a0f 0%, #2d1b4e 100%)',
      ...
      boxShadow: {
        'midnight': '0 4px 6px -1px rgba(16, 16, 34, 0.3), 0 2px 4px -1px rgba(16, 16, 34, 0.2)',
  ...
  plugins: [
    ...
    function({ addUtilities, addComponents, theme }) {
      ...
      const newComponents = {
        // Card components
        '.card-midnight': {
          background: 'linear-gradient(135deg, rgba(10, 10, 15, 0.8) 0%, rgba(45, 27, 78, 0.8) 100%)',
          'backdrop-filter': 'blur(10px)',
          border: '1px solid rgba(119, 93, 206, 0.2)',
        ...
        '.card-nyx': {
          background: 'linear-gradient(135deg, rgba(26, 10, 46, 0.8) 0%, rgba(119, 93, 206, 0.8) 100%)',
          'backdrop-filter': 'blur(10px)',
