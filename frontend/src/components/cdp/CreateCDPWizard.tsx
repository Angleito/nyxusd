...
export const CreateCDPWizard: React.FC<CreateCDPWizardProps> = ({
  onClose,
}) => {
          ...
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Enter your wallet address to create the CDP
              </p>
            </div>
                ...
                <div className="relative">
                  ...
                  <div className="absolute inset-y-0 right-0 pr-3 flex items-center">
                    <span className="text-gray-400">
                      {watchedValues.owner &&
                      watchedValues.owner.match(/^0x[a-fA-F0-9]{40}$/)
                        ? "✅"
                        : "⚠️"}
                    </span>
                  </div>
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Choose your collateral type and amount
              </p>
            </div>
                ...
                <div className="relative">
                  <input
                    {...register("debtAmount", {
                      ...
                      min: {
                        value: 100,
                        message: "Minimum debt is 100 nyxUSD",
                      },
                    })}
                    type="number"
                    step="1"
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-4 space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium text-gray-900">
                    ...
                    {(
                      (debtAmount * 1.5) /
                      parseFloat(watchedValues.collateralAmount || "1")
                    ).toFixed(0)}
                  </span>
                </div>
              </div>
              ...
              {healthFactor < 1.5 && (
                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                  ...
                  <p className="text-sm text-red-700 mt-1">
                    This position has a high risk of liquidation. Consider
                    reducing debt or adding more collateral.
                  </p>
                </div>
              )}
            </div>
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Please review your CDP details before creation
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-6 space-y-4">
              <div className="flex justify-between items-center pb-4 border-b border-gray-200">
                ...
                <span className="font-mono text-sm">
                  {watchedValues.owner?.slice(0, 6)}...
                  {watchedValues.owner?.slice(-4)}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center pb-4 border-b border-gray-200">
                ...
                <span className="font-medium">
                  {watchedValues.debtAmount} nyxUSD
                </span>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm text-blue-700">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    <li>
                      Your collateral may be liquidated if the health factor
                      falls below 1.0
                    </li>
                    <li>
                      You&apos;ll need to maintain a minimum collateralization
                      ratio of 150%
                    </li>
