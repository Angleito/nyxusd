          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-indigo-700">
                {privacy
                  ? Math.round(
                      (privacy.successfulZKProofs /
                        privacy.totalPrivateQueries) *
                        100,
                    )
                  : 0}
                %
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <p
                      className={`text-xs ${feed.priceChange24h >= 0 ? "text-green-600" : "text-red-600"}`}
                    >
                ...
                return (
                  <>
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      ...
                      <div className="flex items-center space-x-2">
                        <span
                          className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(feed.status)}`}
                        >
                          {feed.status}
                        </span>
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="font-medium">
                            {feed.staleness}s ago
                          </span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span className="text-gray-500">24h Change</span>
                          <span
                            className={`font-medium ${feed.priceChange24h >= 0 ? "text-green-600" : "text-red-600"}`}
                          >
                            {feed.priceChange24h >= 0 ? "+" : ""}
                            {feed.priceChange24h}%
                          </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="text-center">
              <p className="text-2xl font-bold text-gray-900">
                {consensus.participatingOracles}/{consensus.totalOracles}
              </p>
