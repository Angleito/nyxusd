...
const buttonVariants = {
  ...
  ghost: 'bg-transparent hover:bg-gray-800/50 text-gray-300 hover:text-white border border-transparent hover:border-gray-600',
  destructive: 'bg-red-600 hover:bg-red-700 text-white shadow-lg hover:shadow-red-500/25',
};
