          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 w-full items-center">
            ...
            >
              ...
              <motion.p 
                ...
                variants={itemVariants}
              >
                Mint nyxUSD with zero-knowledge proofs. Experience true financial privacy without compromising on transparency.
              </motion.p>
              ...
              <div className="relative">
                ...
                <div className="relative w-80 h-80 sm:w-96 sm:h-96">
                  ...
                  {[
                    ...
                    { name: 'AVAX', angle: 240, color: 'from-red-500 to-red-600' }
                    ...
                    <motion.div
                      ...
                      initial={{
                        x: Math.cos((collateral.angle * Math.PI) / 180) * 120 - 32,
                        y: Math.sin((collateral.angle * Math.PI) / 180) * 120 - 32,
                      }}
                    >
                      {collateral.name}
                    </motion.div>
                ...
                >
                  <span className="text-green-300 text-xs font-medium">🔐 ZK Verified</span>
                </motion.div>
              </div>
            </motion.div>
          </div>
