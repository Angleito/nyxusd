    ...
    >
      ...
      <div className="relative z-10">
        <div className="flex items-start justify-between mb-6">
          <div>
            <h2 className="text-2xl font-bold mb-2">Welcome to NyxUSD</h2>
            <p className="text-purple-100 text-sm leading-relaxed max-w-md">
              Create privacy-preserving collateralized debt positions and mint
              nyxUSD while maintaining your financial privacy on Midnight.
            </p>
          </div>
