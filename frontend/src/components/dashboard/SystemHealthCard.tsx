    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="mb-4">
          ...
          >
            <div
              ...
              style={{
                width: `${Math.min((systemStats?.systemCollateralizationRatio || 0) / 3, 100)}%`,
              }}
            ></div>
          </div>
        </div>
        ...
        <p className="text-sm text-gray-600">
          The system collateralization ratio indicates the overall health of the
          protocol. A higher ratio means better collateral backing for the debt.
        </p>
      </div>
