        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="mb-16">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">System Overview</h2>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-16">
            ...
            <div className="card-midnight">
              <h3 className="text-2xl font-bold text-white mb-6">Supported Collaterals</h3>
              <div className="space-y-4">
                {(systemStats as any)?.supportedCollaterals?.map((collateral: any) => (
                  <div key={collateral.type} className="p-4 bg-white/5 rounded-lg backdrop-blur-sm border border-purple-500/20">
                    <div className="flex justify-between items-center mb-3">
                      <span className="font-bold text-white">{collateral.name} ({collateral.type})</span>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-white">{collateral.liquidationRatio}%</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-400">Stability Fee:</span>
                        <span className="font-medium text-white">{(collateral.stabilityFee / 100).toFixed(1)}%</span>
                      </div>
                    </div>
                  </div>
                ))}
          ...
          <div className="text-center">
            ...
            <Link 
              to="/cdp" 
              className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white font-semibold rounded-xl transition-all duration-300 shadow-lg hover:shadow-purple-500/25 transform hover:scale-105"
            >
