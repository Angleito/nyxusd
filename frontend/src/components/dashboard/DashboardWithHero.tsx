...
import NyxHeroSection from "./NyxHeroSection";
          ...
          <div className="mb-16">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Real-time metrics and statistics for the NYXUSD protocol
                ecosystem
              </p>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-16">
            ...
            <motion.div className="card-midnight" initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.5 }} whileHover={{ scale: 1.02 }}>
              ...
              <div className="space-y-4">
                {(prices as any)?.prices &&
                  Object.entries((prices as any).prices).map(
                    ([pair, price]) => (
                      <div
                        key={pair}
            ...
            <motion.div className="card-midnight" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.6 }} whileHover={{ scale: 1.02 }}>
              ...
              <div className="space-y-4">
                {(systemStats as any)?.supportedCollaterals?.map(
                  (collateral: any) => (
                    <div
                      key={collateral.type}
                      className="p-4 bg-white/5 rounded-lg backdrop-blur-sm border border-purple-500/20"
                    >
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium text-foreground">
                            {(collateral.stabilityFee / 100).toFixed(1)}%
                          </span>
                        </div>
                      </div>
                    </div>
