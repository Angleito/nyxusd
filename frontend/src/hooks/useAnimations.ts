...
export interface AnimationConfig {
  /** Animation type */
  type: 'fadeIn' | 'slideUp' | 'slideDown' | 'slideLeft' | 'slideRight' | 'scaleIn' | 'custom';
 ...
 */
const getAnimationClasses = (type: AnimationConfig['type'], isVisible: boolean): string => {
...
export const useScrollAnimation = (config: Partial<AnimationConfig> = {}) => {
  ...
  const shouldAnimate = !fullConfig.respectReducedMotion || !prefersReducedMotion();
 ...
 */
export const usePerformantAnimation = (config: Partial<AnimationConfig> = {}) => {
